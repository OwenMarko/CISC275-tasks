...
export function makeBlankQuestion(
    ...
    return {id: id, name: name, type: type, body: "", options: [], expected: "", points: 1, published: false};
}
...
export function toMarkdown(question: Question): string {
    let baseString: string = `# ${question.name}\n${question.body}`;
...
export function duplicateQuestion(id: number, oldQuestion: Question): Question {
    return {...oldQuestion, published: false, name: `Copy of ${oldQuestion.name}`, id: id};
}
